...
export default function HUDRoutingOverlay({ startNode, endNode, commonRoutes, selectedRoute, onSelectRoute, onCancel }: HUDRoutingOverlayProps) {
  return (
    <div className="fixed top-8 left-1/2 -translate-x-1/2 z-40 w-[400px] pointer-events-auto">
      <motion.div
              ...
              <div className="flex flex-wrap gap-2">
                {commonRoutes.map(r => (
                  <button
                    ...
                    className={`px-3 py-1.5 border rounded-sm text-[10px] transition-colors focus:outline-none ${selectedRoute === r
