...
export default function Home() {
  ...
  return (
    <main className="relative w-full min-h-screen bg-[#090b10] text-slate-50 font-sans selection:bg-[#e2cca8]/30">

      {/* MAP */}
      <div className="fixed inset-0 w-full h-full z-0 overflow-hidden bg-dot-grid">
        <DubaiMap
      ...
      <div className="fixed top-48 right-8 z-30 flex flex-col gap-3 font-mono">
        <button
          onClick={() => {
      ...
      {/* NODE STOP OVERLAY (card when clicking a stop) */}
      <AnimatePresence>
      ...
      {/* TOP RIGHT TITLE */}
      <div className="fixed top-0 right-0 z-50 pointer-events-none p-8 flex justify-end items-start w-full">
